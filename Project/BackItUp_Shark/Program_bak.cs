...
namespace BackItUp_Shark
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("BackItUp Shark V1.1 [Build 25/10/2016]");
            ...
            if (args.Length > 2) // Analyse other arguments
            {
                ...
                {
                    if (args[count].ToLower() == "/noinput")
                    {
                        noInput = true;
                    }
                    else if (args[count].ToLower().Contains(customNameIdentifier))
                    {
            ...
            /* INITIATE BACK UP */
            BackItUp_Shark_Core.Backup(args[0], args[1], customBackupName, noInput);
        ...
        static void simpleTUI() 
        {
            while (true) // Main menu loop
            {
                ...
                // Initiate backup
                BackItUp_Shark_Core.Backup(backupTarget, backupLoc, "", true);
        ...
        static void displayHelpMsg() 
        {
            ...
            Console.WriteLine("    BackItUp.exe /? [source] [destination] /name:[name] /noinput ");
            Console.WriteLine();
            ...
            Console.WriteLine("       /noinput       Will run backup without requiring input");
            Console.WriteLine();
            ...
            Console.WriteLine("     >BackItUp G:\\ L:\\ /noinput              ... Backup drive G: to L: ");
            Console.WriteLine("                                               requiring no user input");
            Console.WriteLine("     >BackItUp G:\\ L:\\ /name:woof /noinput   ... Backup drive G: to L: ");
            Console.WriteLine("                                               back up in folder named 'woof'");
            Console.WriteLine("                                               requiring no user input.");
            Console.WriteLine();
